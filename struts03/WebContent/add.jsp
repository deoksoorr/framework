	...
	<div class="row">
		<div class="col-sm-12">
			<div class="jumbotron">
				<h1>Add page</h1>
				<p>...</p>
				<p><a class="btn btn-primary btn-lg" href="./list.action" role="button">back</a></p>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-12">
			<form action="insert.action">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="pay" id="pay" placeholder="페이" value="${param.pay }">
				</div>
